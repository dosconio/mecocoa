...
# Linux Environment
my $ubinpath = $ENV{'ubinpath'};
$a = "/usr/share/bochs/";
$floimg = "${ubinpath}/I686/mecocoa/mccax86.img";
...
# VGA VIOS
print "vgaromimage: file=\"${a}VGABIOS-lgpl-latest.bin\"\n";
...
print "ata0-master: type=disk, path=\"${ubinpath}/fixed2.vhd\", mode=flat, cylinders=32, heads=2, spt=32, sect_size=512, model=\"Generic 1234\", biosdetect=auto, translation=lba\n";
