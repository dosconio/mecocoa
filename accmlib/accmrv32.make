...
cpppref=_cx_
cppfile=$(wildcard $(ulibpath)/cpp/*.cpp) $(wildcard $(ulibpath)/cpp/dat-block/*.cpp) $(wildcard accmlib/*.cpp) $(ulibpath)/cpp/lango/lango-cpp.cpp
...
CFLAGS += -fno-builtin -Wall -Wno-unused-variable -Wno-unused-function -Wno-parentheses
CFLAGS += -march=rv32g -mabi=ilp32
CFLAGS += -I$(uincpath) -Iaccmlib/sysroot/usr/include -D_ACCM=0x1032 -D_OPT_RISCV32 -D_DEBUG
